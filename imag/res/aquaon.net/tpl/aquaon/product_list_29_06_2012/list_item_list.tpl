...
margin: 3px auto;">
			<img 	style="width: 100%;"
					src="../../josi/image.php?width=150px&height=150px&image=/webproj/aquaon/aquaon/res/img/cristal_rain_1.png"/>
		</div>
	</div>
	<div 	class="div_left" style="width:60%;cursor:pointer"
		...
		<div 	style="font-size: 14pt;margin-top:15px" 
				class="js_form_item"
				data-josi-ev-stop=true
				data-josi-ev-resp="change_val"				data-josi-kvl-str="ev:{change_val}^f:map_reduce^context_struct_res_key:struct_get_arr.tab_item.[[f:kvl_1_mix_val^mix_key:__i]]&map_f:.price+.container_price&place_to:.price"
				>
