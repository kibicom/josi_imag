...
<div class="josi_list_stl_smpl_" style="height: 100%;">
	...
	<div 	class="josi_list product_list"
			...
			[[f:tpl_struct_arr^query:'.comment'=='[[f:struct_val^key:hash.cat_group]]'&tpl_path:res/tpl/aquaon/product_list/list_item_equip.tpl&struct_res_key:struct_get_arr.{{f:show_val^res_name&key:res_name}}&node_class_query:&replace:true&rooted:false&append:false&parse_arr:true]]
