...
<div 	class="josi_store_form_item">
	...
	<div class="div_left josi_store_form_item_val_div" style="width: [[f:kvl_1_mix_val^mix_key:val_w&def_val:50]]%;">
		...
		<div class="popup_list_div v_scroll hidden" style="width: auto;height: auto;cursor: default;">
			<div style="">
				[[f:tpl^tpl_path:tpl/val_list/val_li_cli.tpl&val:1пол.дня&struct_key:[[f:kvl_1_mix_val^mix_key:val_key]]&struct_val:1пол.дня]]
				[[f:tpl^tpl_path:tpl/val_list/val_li_cli.tpl&val:2пол.дня&struct_key:[[f:kvl_1_mix_val^mix_key:val_key]]&struct_val:2пол.дня]]
			</div>
		</div>
	</div>
</div>
